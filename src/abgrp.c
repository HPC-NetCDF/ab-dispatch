/**
 * @file 
 * @internal This file handles groups for the AB dispatch layer. All
...
*/
int
AB_def_grp(int parent_ncid, const char *name, int *new_ncid)
{
   return NC_EPERM;
}
...
*/
int
AB_rename_grp(int grpid, const char *name)
{
   return NC_EPERM;   
}
