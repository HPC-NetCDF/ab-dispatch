...
*/
int
AB_def_compound(int ncid, size_t size, const char *name, nc_type *typeidp)
{
   return NC_ENOTNC4;
}
...
*/
int
AB_insert_compound(int ncid, nc_type typeid1, const char *name, size_t offset, 
...
*/
extern int
AB_insert_array_compound(int ncid, int typeid1, const char *name, 
...
*/
int
AB_inq_compound_field(int ncid, nc_type typeid1, int fieldid, char *name, 
...
*/
int
AB_inq_compound_fieldindex(int ncid, nc_type typeid1, const char *name, int *fieldidp)
{
   return NC_ENOTNC4;
}
...
*/
int
AB_def_opaque(int ncid, size_t datum_size, const char *name, 
	      nc_type *typeidp)
{
   return NC_ENOTNC4;
}
...
*/
int
AB_def_vlen(int ncid, const char *name, nc_type base_typeid, 
	    nc_type *typeidp)
{
   return NC_ENOTNC4;
}
...
*/
int
AB_def_enum(int ncid, nc_type base_typeid, const char *name, 
	    nc_type *typeidp)
{
   return NC_ENOTNC4;
}
...
*/
int
AB_inq_enum_ident(int ncid, nc_type xtype, long long value, char *identifier)
{
   return NC_ENOTNC4;
}
...
*/
int
AB_inq_enum_member(int ncid, nc_type typeid1, int idx, char *identifier, 
		   void *value)
{
   return NC_ENOTNC4;
}
...
*/
int
AB_insert_enum(int ncid, nc_type typeid1, const char *identifier, 
	       const void *value)
{
   return NC_ENOTNC4;
}
...
*/
int
AB_put_vlen_element(int ncid, int typeid1, void *vlen_element, 
...
*/
int
AB_get_vlen_element(int ncid, int typeid1, const void *vlen_element, 
