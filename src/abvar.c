 ...
 */
int
AB_set_var_chunk_cache(int ncid, int varid, size_t size, size_t nelems,
                         float preemption)
{
   return NC_ENOTNC4;
}
 ...
 */
int
AB_get_var_chunk_cache(int ncid, int varid, size_t *sizep,
 ...
 *
 * @returns ::NC_EPERM Not allowed for AB.
 * @author Ed Hartnett
 */
int
AB_def_var(int ncid, const char *name, nc_type xtype,
 ...
 */
int
AB_def_var_deflate(int ncid, int varid, int shuffle, int deflate,
                     int deflate_level)
{
   return NC_EPERM;
}
 ...
 */
int
AB_def_var_fletcher32(int ncid, int varid, int fletcher32)
{
   return NC_ENOTNC4;
}
 ...
 */
int
AB_def_var_chunking(int ncid, int varid, int contiguous, const size_t *chunksizesp)
{
   return NC_EPERM;
}
 ...
 */
int
AB_def_var_fill(int ncid, int varid, int no_fill, const void *fill_value)
{
   return NC_ENOTNC4;
}
 ...
 */
int
AB_def_var_endian(int ncid, int varid, int endianness)
{
   return NC_ENOTNC4;
}
 ...
 */
int
AB_def_var_filter(int ncid, int varid, unsigned int id, size_t nparams,
 ...
 */
int
AB_var_par_access(int ncid, int varid, int par_access)
{
   return NC_ENOTNC4;
}
 ...
 */
int
AB_put_vara(int ncid, int varid, const size_t *startp,
